    ...
    <AppBar position="static" color="white">
      <Toolbar>
        ...
        <Typography variant="h5" className={classes.home} underlineNone	>
          <Link href="../main-page" className={classes.home2} color="inherit" style={{ textDecoration: 'none' }}>
            MAIN PAGE
          </Link>
        </Typography>
        <Divider style={{ marginTop: '10px', marginBottom: '10px' }} orientation="vertical" variant="middle" flexItem />
        <Typography variant="h5" className={classes.title}>
          <Link href="../message" className={classes.title2} color="inherit" style={{ textDecoration: 'none' }}>
            MESSAGES
          </Link>
        </Typography>
        <Divider style={{ marginTop: '10px', marginBottom: '10px' }} orientation="vertical" variant="middle" flexItem />
        ...
        <Divider style={{ marginTop: '10px', marginBottom: '10px' }} orientation="vertical" variant="middle" flexItem />
        <Typography variant="h5" className={classes.notifications}>
          NOTIFICATIONS
        </Typography>
